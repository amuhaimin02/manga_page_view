...
class MangaPageCarousel extends StatefulWidget {
  ...
  @override
  State<MangaPageCarousel> createState() => MangaPageCarouselState();
}

class MangaPageCarouselState extends State<MangaPageCarousel>
  ...
  @override
  void didUpdateWidget(covariant MangaPageCarousel oldWidget) {
